...
/**
 Base class for all Avalanche views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Avalanche view hierarchy (such as wrapped iOS UIViews) was touched.
