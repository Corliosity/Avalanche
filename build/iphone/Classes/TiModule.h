...
/**
 The base class for all Avalanche modules
 */
...
/**
 Avalanche Platform calls this method on startup.
 */
-(void)startup;

/**
 Avalanche Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Avalanche Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Avalanche Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Avalanche Platform calls this method on resume.
 @param sender The sender of the event.
 */
