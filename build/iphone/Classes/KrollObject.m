...
//@interface AvalancheObject : NSObject
//@end

@interface AvalancheObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AvalancheObject class]])
		{
			for (NSString *key in [[(AvalancheObject*)o modules] allKeys])
			{
