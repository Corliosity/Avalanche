...
// in simulator we redefine to format for Avalanche Developer console
...
{\
	NSString * exceptionName = [@"org.avalanche." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avalanche";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAvalancheNativeItemNone = -1, 
	UIAvalancheNativeItemSpinner = -2,
	UIAvalancheNativeItemProgressBar = -3,
	
	UIAvalancheNativeItemSlider = -4,
	UIAvalancheNativeItemSwitch = -5,
	UIAvalancheNativeItemMultiButton = -6,
	UIAvalancheNativeItemSegmented = -7,
	
	UIAvalancheNativeItemTextView = -8,
	UIAvalancheNativeItemTextField = -9,
	UIAvalancheNativeItemSearchBar = -10,
	
	UIAvalancheNativeItemPicker = -11,
	UIAvalancheNativeItemDatePicker = -12,
	
	UIAvalancheNativeItemInfoLight = -13,
	UIAvalancheNativeItemInfoDark = -14,
	
	UIAvalancheNativeItemDisclosure = -15,
	
	UIAvalancheNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Avalanche instances of
