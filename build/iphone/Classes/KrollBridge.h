...
@interface AvalancheObject : KrollCoverageObject {
#else
@interface AvalancheObject : KrollObject {
#endif
@private
...
extern NSString * Avalanche$ModuleRequireFormat;
